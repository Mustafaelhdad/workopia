    ...
    <div class="mx-auto w-full rounded-lg bg-white p-8 shadow-md md:max-w-3xl">
        ...
        <form method="POST" action="/jobs" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input class="w-full rounded border px-4 py-2 focus:outline-none" id="salary" name="salary"
                    type="number" placeholder="90000" />
            </div>
            ...
            <div class="mb-4">
                ...
                <input class="w-full rounded border px-4 py-2 focus:outline-none" id="tags" name="tags"
                    type="text" placeholder="development,coding,java,python" />
            </div>
            ...
            <div class="mb-4">
                ...
                <input class="w-full rounded border px-4 py-2 focus:outline-none" id="address" name="address"
                    type="text" placeholder="123 Main St" />
            </div>

            <div class="mb-4">
                <label class="block text-gray-700" for="city">City</label>
                <input class="w-full rounded border px-4 py-2 focus:outline-none" id="city" name="city"
                    type="text" placeholder="Albany" />
            </div>

            <div class="mb-4">
                <label class="block text-gray-700" for="state">State</label>
                <input class="w-full rounded border px-4 py-2 focus:outline-none" id="state" name="state"
                    type="text" placeholder="NY" />
            </div>

            <div class="mb-4">
                <label class="block text-gray-700" for="zipcode">ZIP Code</label>
                <input class="w-full rounded border px-4 py-2 focus:outline-none" id="zipcode" name="zipcode"
                    type="text" placeholder="12201" />
            </div>
            ...
            <div class="mb-4">
                ...
                <input class="w-full rounded border px-4 py-2 focus:outline-none" id="company_name"
            ...
            <div class="mb-4">
                ...
                <input class="w-full rounded border px-4 py-2 focus:outline-none" id="company_website"
                    name="company_website" type="text" placeholder="Enter website" />
            </div>

            <div class="mb-4">
                <label class="block text-gray-700" for="contact_phone">Contact Phone</label>
                <input class="w-full rounded border px-4 py-2 focus:outline-none" id="contact_phone"
                    name="contact_phone" type="text" placeholder="Enter phone" />
            </div>

            <div class="mb-4">
                <label class="block text-gray-700" for="contact_email">Contact Email</label>
                <input class="w-full rounded border px-4 py-2 focus:outline-none" id="contact_email"
                    name="contact_email" type="email" placeholder="Email where you want to receive applications" />
            </div>
